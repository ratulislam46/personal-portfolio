                ...
                >
                    ...
                    >
                        <motion.a
                            ...
                            className="group relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-base-100 border-2 border-base-content/10 hover:border-info/40 rounded-xl shadow-md hover:shadow-info/20 flex items-center justify-center transition-all duration-300"
                    ...
                    >
                        <motion.a
                            href="https://drive.google.com/file/d/1D9674yQ3PqMiFjLuZBTq_91lVpKQ4dJB/view?usp=drive_link"
